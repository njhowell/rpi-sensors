...
while True:
    ...
    logging.info("Got light level of %s", str(lightlevel))
    ...
    LogToPRTG.LogValue("Light Level", str(lightlevel), envirophatconfig.light_api_key, envirophatconfig.light_port, envirophatconfig.prtg_host, envirophatconfig.use_ssl)
